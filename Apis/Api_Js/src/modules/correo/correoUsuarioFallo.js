        ...
        let correo = await transportadorCorreo.sendMail({
            ...
            html:`
                    ...
                    <p style="font-family:'Segoe UI', 'Lucida Sans', sans-serif; font-size: 1rem;">
                        Estimad@ <span class="resaltados" style="font-weight: bold;color: rgb(12, 33, 53);">${datos.nombre}</span> espero te encuentres muy bien. De parte de <span class="resaltados" style="font-weight: bold;color: rgb(12, 33, 53);">ACS - Aciel Soluciones Integrales S.A.S y el equipo de soporte técnico</span>,te notificamos que se ha presentado un fallo en la creación de tu firma digital, por lo que debes de revisar bien la información registrada en el formualario, la firma la podrás encontrar dentro de la plataforma y allí mismo la podrás usar.
                    </p>
