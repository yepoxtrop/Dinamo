        ...
        let correo = await transportadorCorreo.sendMail({
            ...
            html:`
                    ...
                    <p style="font-family:'Segoe UI', 'Lucida Sans', sans-serif; font-size: 1rem;">
                        Estimad@ <span class="resaltados" style="font-weight: bold;color: rgb(12, 33, 53);">${datos.supervisor}</span> espero te encuentres muy bien. De parte de <span class="resaltados" style="font-weight: bold;color: rgb(12, 33, 53);">ACS - Aciel Soluciones Integrales S.A.S y el equipo de soporte técnico</span>,te notificamos que el colaborador <span style="font-weight: bold;color: rgb(12, 33, 53);">${datos.nombre}</span> ha hecho solicitado la creación de una firma digital, el objetivo del presete correo es informale sobre este suceso para que tenga el seguimiento de las actividades en la plataforma de firmas.
                    </p>

                    <p style="font-family:'Segoe UI', 'Lucida Sans', sans-serif; font-size: 1rem;">
                        En caso de que tenga alguna duda respecto a estos eventos, puede comunicarse con el área de soporte técnico perteneciente al área de tecnología.
                    </p>
